...
public class UserResource {
	...
	// INDICAR QUE A REQUISIÇÃO VAI ACEITAR UM ID DENTRO DA URL - ACESSAR O ID DO USUARIO
	@GetMapping(value  = "/{id}")
	...
	@PostMapping // PRÉ-PROCESSAMENTO DA COMPILAÇÃO DO CONTROLADOS, DEFININDO QUE ESSE METODO VAI RECEBER O METODO POST DO HTTP
